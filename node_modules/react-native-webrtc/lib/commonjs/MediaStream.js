...
class MediaStream extends (0, _eventTargetShim.defineCustomEventTarget)(...MEDIA_STREAM_EVENTS) {
  /**
   ...
   */
  constructor(arg) {
    super(); // Assigm a UUID to start with. It may get overridden for remote streams.
    ...
    this.id = (0, _RTCUtil.uniqueID)(); // Local MediaStreams are created by WebRTCModule to have their id and
